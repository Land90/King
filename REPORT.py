...
TELEGRAM_BOT_TOKEN = '7713010443:AAFtKU00FrG1J0MIgZYqFn4m2JTMhdKibBc'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "🌟 **WELCOME TO THE SHAILU VIP DDOS!** 🌟\n\n"
...
async def attack(update: Update, context: CallbackContext):
    ...
    if not is_user_allowed(user_id):
        await context.bot.send_message(chat_id=chat_id, text="❌ **Access Denied!** You are not authorized to use this premium service @MRSHAILU01.", parse_mode='Markdown')
        return
...
async def add_user(update: Update, context: CallbackContext):
    ...
    if user_id_sender != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=chat_id, text="❌ **Access Denied!** Only admin can add users @MRSHAILU01.", parse_mode='Markdown')
        return
